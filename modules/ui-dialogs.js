  ...
  if (tags) {
    html += `
      <div class="modal-tags" style="display: flex; gap: 6px; flex-wrap: wrap; margin-bottom: 16px; padding-bottom: 12px; border-bottom: 1px solid rgba(255, 255, 255, 0.08);">
        <span class="info-tag" style="background: rgba(16, 185, 129, 0.12); border: 1px solid rgba(16, 185, 129, 0.3); color: #10b981; font-size: 0.8rem; font-weight: 700; padding: 3px 8px; border-radius: 6px; text-transform: uppercase; letter-spacing: 0.02em;">🌍 Region: ${tags.region}</span>
        <span class="info-tag" style="background: rgba(59, 130, 246, 0.12); border: 1px solid rgba(59, 130, 246, 0.3); color: #3b82f6; font-size: 0.8rem; font-weight: 700; padding: 3px 8px; border-radius: 6px; text-transform: uppercase; letter-spacing: 0.02em;">🥁 Type: ${tags.type}</span>
        ${tags.features.map((f) => `<span class="info-tag" style="background: rgba(245, 158, 11, 0.12); border: 1px solid rgba(245, 158, 11, 0.3); color: #f59e0b; font-size: 0.8rem; font-weight: 700; padding: 3px 8px; border-radius: 6px; text-transform: uppercase; letter-spacing: 0.02em;">✨ ${f}</span>`).join('')}
      </div>
    `;
  }
      ...
      html += `
        <div class="info-list-item" style="display: flex; justify-content: space-between; align-items: center; gap: 8px;">
          ...
          <div class="streaming-pills" style="margin-top: 0;">
            ${
              p.spotify
                ? `<a href="${spotifySearchUrl}" target="_blank" class="streaming-pill streaming-pill-spotify">
            ...
            ${
              p.apple
                ? `<a href="${appleSearchUrl}" target="_blank" class="streaming-pill streaming-pill-apple">
